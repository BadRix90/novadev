export const EN_TEXTS = {
  ...
  vision: {
    header: {
      badge: "NOVADEV OASIS",
      title: "NovaDev OASIS Vision",
      subtitle: "The roadmap for modern web development from Lüneburg",
    },
    intro: {
      text: "Welcome to the NovaDev Edge vision! We believe the future of web development consists of communities – real relationships and platforms that provide genuine value to developers and businesses. With VISION, a central ecosystem for Angular freelancers and SMEs is emerging. Our roadmap transparently shows where we're headed – following the Halliday Principle.",
    },
    principles: {
      title: "The Halliday Principle",
      subtitle: "Why we build the way we build",
      items: [
        {
          icon: "users",
          title: "Community First",
          description: "No VC investors, no aggressive monetization. We build for the community, not for investors.",
        },
        {
          icon: "shield",
          title: "100% Ownership",
          description: "Full control, no dependencies. We remain independent and decide our own future.",
        },
        {
          icon: "heart",
          title: "Passion for Product",
          description: "Genuine enthusiasm for what we build. Quality over quantity, always.",
        },
        {
          icon: "target",
          title: "Transparency & Openness",
          description: "Clear roadmap, honest communication. You see every step of our development.",
        },
      ],
    },
    roadmap: {
      ...
      phases: [
        {
          ...
          description: "Community building and platform idea validation",
          milestones: [
            "Launch Discord community (100+ Angular freelancers)",
            "Launch newsletter & blog",
            "Needs analysis through interviews",
            "MVP development & private beta",
          ],
        },
        {
          year: "2027",
          title: "Phase 2: Launch",
          description: "Public launch and initial scaling",
          milestones: [
            "Public beta for all users",
            "DevHub & ClientHub features",
            "Template marketplace prototype",
            "First 200+ active users",
          ],
        },
        {
          year: "2028",
          title: "Phase 3: Growth",
          description: "Platform stabilization and optimization",
          milestones: [
            "UI/UX optimization & mobile-first",
            "Expand community features",
            "Evaluate expansion to other frameworks",
            "400+ users, >€50K revenue/month",
          ],
        },
        {
          year: "2029+",
          title: "Phase 4: Ecosystem",
          description: "Sustainable growth and financial freedom",
          milestones: [
            "Modular extensions based on community feedback",
            "Develop partner niches",
            "Team <10 people, 100% ownership",
            "Financial freedom for all stakeholders",
          ],
        },
      ],
    },
      ...
      values: [
        {
          ...
          text: "No anonymous transactions, but long-term partnerships",
        },
        {
          icon: "zap",
          title: "Fast Iteration",
          text: "Feedback is heard and quickly implemented",
        },
        {
          icon: "shield",
          title: "No Vendor Lock-ins",
          text: "Your data belongs to you, always",
        },
        {
          icon: "target",
          title: "Focus on Quality",
          text: "Better slow and good than fast and bad",
        },
        {
          icon: "heart",
          title: "Respectful Interaction",
          text: "We treat everyone as we want to be treated",
        },
        {
          icon: "code2",
          title: "Open Development",
          text: "Transparent development, public roadmap",
        },
      ],
    },
    cta: {
      title: "Become Part of the Movement",
      text: "Join our community and help shape the future of web development. No spam, only real updates.",
      discord: "https://discord.gg/novadev",
