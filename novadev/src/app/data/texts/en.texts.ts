export const EN_TEXTS = {
  ...
  privacyPolicy: {
    ...
    projectData: {
      ...
      intro: 'As part of providing my services (web development, design, consulting), I process various types of data required for project implementation.',
      categories: {
    ...
    security: {
      ...
      intro: 'I implement technical and organizational security measures to protect your data from loss, manipulation and unauthorized access.',
      measures: {
